...
namespace PROJECT_STUDENT_MANAGEMENT_FINAL_EXAMINATION
{
    public partial class ScoreForm : Form
    {
        ...
        {
            DataGridView_student.DataSource = score.getList(new SqlCommand("SELECT score.StudentId,student.StdFirstName,student.StdLastName,score.CourseName,score.Score,score.Description FROM student INNER JOIN score ON score.StudentId=student.StdId"));
        }
        ...
        private void ScoreForm_Load(object sender, EventArgs e)
        {
            ...
            DataGridView_student.DataSource = student.getList(new SqlCommand("SELECT [StdId], [StdFirstName], [StdLastName] FROM [student]"));
            //DataGridView_student.DataSource = student.getList(new SqlCommand("SELECT `StdId`,`StdFirstName`,`StdLastName` FROM `student`"));
        }
